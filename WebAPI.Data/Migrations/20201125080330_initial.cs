        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productCategoriesidCategory = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.productCategoriesidCategory,
                        principalTable: "productCategories",
                        principalColumn: "idCategory",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "cb5a5e66-4a1a-4f17-8d0e-cbf34584cdd3", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "idCategory", "LanguageId", "categoryName", "idProduct" },
                values: new object[,]
                {
                    { 1, null, "Shoes", null },
                    { 2, null, "Shirt", null }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "d5e7bd4d-63d2-44eb-89fb-1c1b8ecb0c27", "nhattruongtp2000@gmail.com", true, false, null, "nhattruongtp2000@gmail.com", "admin", "AQAAAAEAACcQAAAAEHlnUqdnVmvae/g7c14XSSN7eeAnt0+ml4YHOby9HXcQ0o278TzukdKnV5NJ/PdN/w==", null, false, "", false, "admin", "2020-10-12 00:00:00", "Nguyen", null, new DateTime(2020, 11, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "Truong", null, null });
            ...
            migrationBuilder.InsertData(
                table: "products",
                columns: new[] { "idProduct", "ViewCount", "idBrand", "idColor", "idSize", "idType", "ordersDetailsidOrder" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "idProductDetail", "LanguageId", "ProductName", "dateAdded", "detail", "expiredSalingDate", "idProduct", "isSaling", "price", "productCategoriesidCategory", "salePrice" },
                values: new object[] { 1, "vi-VN", "Shoe", new DateTime(2019, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "goood product", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, false, "1000000", null, "1000000" });

            migrationBuilder.InsertData(
                table: "productDetails",
                columns: new[] { "idProductDetail", "LanguageId", "ProductName", "dateAdded", "detail", "expiredSalingDate", "idProduct", "isSaling", "price", "productCategoriesidCategory", "salePrice" },
                values: new object[] { 2, "vi-VN", "Pro", new DateTime(2019, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "goood product", new DateTime(2020, 10, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, false, "2000000", null, "1000000" });
